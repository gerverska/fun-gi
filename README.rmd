...
```{r demultiplex-fwd, include=TRUE}

htmltools::includeHTML(file.path('01-demultiplex', 'logs', 'R1.html'))
...
```{r demultiplex-rev, include=TRUE}

htmltools::includeHTML(file.path('01-demultiplex', 'logs', 'R2.html'))
...
```{r trim-fwd, include=TRUE}

htmltools::includeHTML(file.path('02-trim', 'logs', 'trim3-R1.html'))
...
```{r trim-rev, include=TRUE}

htmltools::includeHTML(file.path('02-trim', 'logs', 'trim3-R2.html'))
...
```{r denoise-fwd, include=TRUE}

htmltools::includeHTML(file.path('03-denoise', 'logs', 'filt-R1.html'))
...
```{r denoise-rev, include=TRUE}

htmltools::includeHTML(file.path('03-denoise', 'logs', 'filt-R2.html'))
