...
![fun-error-fwd](03-denoise/logs/fun-error-fwd.png){width=45%} ![fun-error-rev](03-denoise/logs/fun-error-rev.png){width=45%}

![gi-error-fwd](03-denoise/logs/gi-error-fwd.png){width=45%} ![gi-error-rev](03-denoise/logs/gi-error-rev.png){width=45%}
...
a ![full-residuals](06-analyze/logs/full-residuals.png){width=30%} b ![fun-full-rand](06-analyze/logs/fun-full-rand.png){width=30%} c ![gi-full-rand](06-analyze/logs/gi-full-rand.png){width=30%}
