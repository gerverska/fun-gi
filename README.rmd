...
```{bash conda, include=TRUE, echo=FALSE}

conda --version
cat config.yml

```
The entire bioinformatic environment can be installed from the above `config.yml` using the script `00-build.sh`
```
